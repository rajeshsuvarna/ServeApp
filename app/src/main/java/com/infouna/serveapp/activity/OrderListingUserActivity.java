...
public class OrderListingUserActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        adapter = new RVAdapter(data, mDatasetTypes[2]); //array position is [0] coz card card type is HOME
    ...
    public List<OrderListCardUser> fill_with_data(String url, String spid) {
        ...
        jsonObjReq = new JsonObjectRequest(Request.Method.GET, url, null, new Response.Listener<JSONObject>() {
            ...
            public void onErrorResponse(VolleyError error) {
                Toast.makeText(OrderListingUserActivity.this, error.getMessage(), Toast.LENGTH_SHORT).show();
            }
